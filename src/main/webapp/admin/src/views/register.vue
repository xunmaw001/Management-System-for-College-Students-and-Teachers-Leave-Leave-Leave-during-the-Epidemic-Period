  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(88, 179, 81, 0.6);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 247, 247, 1);fontSize:28px;">疫情期间高校师生外出请假管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.bianhao" class="input" type="text" placeholder="编号">
			   </div>
			 </div> -->
			<el-form-item label="编号" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.bianhao" autocomplete="off" placeholder="编号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			...
			<el-form-item label="联系邮箱" class="input" v-if="tableName=='jiaoshi'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`jiaoshi` == this.tableName && this.ruleForm.lianxiyouxiang&&(!this.$validate.isEmail(this.ruleForm.lianxiyouxiang))){
