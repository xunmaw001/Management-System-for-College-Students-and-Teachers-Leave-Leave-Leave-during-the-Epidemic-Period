  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshi'"  label="教师性别" prop="jiaoshixingbie">
          <el-select v-model="ruleForm.jiaoshixingbie" placeholder="请选择教师性别">
            <el-option
                v-for="(item,index) in jiaoshijiaoshixingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="编号" prop="bianhao">
          <el-input v-model="ruleForm.bianhao"               placeholder="编号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="联系邮箱" prop="lianxiyouxiang">
          <el-input v-model="ruleForm.lianxiyouxiang"               placeholder="联系邮箱" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='jiaoshi'" label="教师照片" prop="jiaoshizhaopian">
          <file-upload
          tip="点击上传教师照片"
          action="file/upload"
          :limit="3"
          ...
          @change="jiaoshijiaoshizhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  mounted() {
    ...
    this.jiaoshijiaoshixingbieOptions = "男,女".split(',')
  },
  methods: {
    xueshengtouxiangUploadChange(fileUrls) {
        this.ruleForm.touxiang = fileUrls;
    },
    jiaoshijiaoshizhaopianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if( 'jiaoshi' ==this.flag && this.ruleForm.lianxiyouxiang&&(!isEmail(this.ruleForm.lianxiyouxiang))){
