<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教师性别" prop="jiaoshixingbie">
          <el-select v-model="ruleForm.jiaoshixingbie" placeholder="请选择教师性别">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="教师性别" prop="jiaoshixingbie">
	      <el-input v-model="ruleForm.jiaoshixingbie"
                placeholder="教师性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jiaoshizhaopian" label="教师照片" prop="jiaoshizhaopian">
          <file-upload
          tip="点击上传教师照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.jiaoshizhaopian?ruleForm.jiaoshizhaopian:''"
          @change="jiaoshizhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.jiaoshizhaopian" label="教师照片" prop="jiaoshizhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiaoshizhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	jiaoshixingbie : false,
	xueyuan : false,
	bianhao : false,
	lianxidianhua : false,
	lianxiyouxiang : false,
	jiaoshizhaopian : false,
      },
      ruleForm: {
        jiaoshigonghao: '',
        mima: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='jiaoshixingbie'){
            this.ruleForm.jiaoshixingbie = obj[o];
	    this.ro.jiaoshixingbie = true;
            continue;
          }
          if(o=='xueyuan'){
	    ...
	    this.ro.lianxiyouxiang = true;
          ...
          if(o=='jiaoshizhaopian'){
            this.ruleForm.jiaoshizhaopian = obj[o];
	    this.ro.jiaoshizhaopian = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.jiaoshizhaopian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
